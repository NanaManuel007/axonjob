<script lang="ts">
    ...
    async function handleDownloadAll() {
        const zip = new JSZip();
        const candidateName = `${candidate.name}_${candidate.phoneNumber}`.toLowerCase();
    ...
    const documents: Document[] = [
        { type: 'CV/Resume', status: 'Verified', icon: 'description', date: '2023-10-15', isImage: false, isPdf: true, url: '/path/to/cv.pdf' },
        { type: 'DBS Certificate', status: 'Pending', icon: 'verified_user', date: '2023-10-14', isImage: false, isPdf: true, url: '/path/to/dbs.pdf' },
        { type: 'Qualifications', status: 'Verified', icon: 'school', date: '2023-10-13', isImage: false, isPdf: true, url: '/path/to/quals.pdf' },
        { type: 'National ID', status: 'Verified', icon: 'badge', date: '2023-10-12', isImage: true, url: '/path/to/national-id.jpg' },
        { type: 'Right to Work UK', status: 'Pending', icon: 'work', date: '2023-10-11', isImage: false, isPdf: true, url: '/path/to/rtw.pdf' },
        { type: 'Identification Picture', status: 'Verified', icon: 'photo_camera', date: '2023-10-10', isImage: true, url: '/path/to/id-picture.jpg' },
        { type: 'Proof of Address', status: 'Verified', icon: 'home', date: '2023-10-09', isImage: true, url: '/path/to/address-proof.jpg' }
    ];
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            {#if doc.isPdf}
                                <button 
                                    ...
                                    on:click={() => handleViewPdf(doc.url)}
                                >
